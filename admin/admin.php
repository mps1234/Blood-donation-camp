...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6">
				<p>Total no. of registered candidates are <?php 
		...
		<div class="row">
			<div class="col-md-6">
				<p>Total no. of candidates with blood group A+ are <?php 
		...
		<div class="row">
			<div class="col-md-6">
				<p>Total no. of candidates with blood group B+ are <?php
		...
		<div class="row">
			<div class="col-md-6">
				<p>Total no. of candidates with blood group AB+ are <?php 
		...
		<div class="row">
			<div class="col-md-6">
				<p>Total no. of candidates with blood group O+ are <?php 
		...
		<div class="row">
			<div class="col-md-6">
				<p>Total no. of candidates with blood group not available are <?php 
