...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6">
				<p>Total no. of registered canidates are <?php 
		...
		<div class="row">
			<div class="col-md-6">
				<p>Total no. of canidates with blood group A+ are <?php 
					$query = "SElECT * FROM registration_data WHERE blood_group = 'Ap'";
					$res = mysqli_query($con,$query);
					$no = mysqli_num_rows($res);
					echo $no;
					?>
		...
		<div class="row">
			<div class="col-md-6">
				<p>Total no. of canidates with blood group A- are <?php 
					$query = "SElECT * FROM registration_data WHERE blood_group = 'An'";
					$res = mysqli_query($con,$query);
					$no = mysqli_num_rows($res);
					echo $no;
					?>
		...
		<div class="row">
			<div class="col-md-6">
				<p>Total no. of canidates with blood group B+ are <?php
					$query = "SElECT * FROM registration_data WHERE blood_group = 'Bp'";
					$res = mysqli_query($con,$query);
					$no = mysqli_num_rows($res);
					echo $no;
					?>
		...
		<div class="row">
			<div class="col-md-6">
				<p>Total no. of canidates with blood group B- are <?php 
					$query = "SElECT * FROM registration_data WHERE blood_group = 'Bn'";
					$res = mysqli_query($con,$query);
					$no = mysqli_num_rows($res);
					echo $no;
					?>
		...
		<div class="row">
			<div class="col-md-6">
				<p>Total no. of canidates with blood group AB+ are <?php 
					$query = "SElECT * FROM registration_data WHERE blood_group = 'ABp'";
					$res = mysqli_query($con,$query);
					$no = mysqli_num_rows($res);
					echo $no;
					?>
		...
		<div class="row">
			<div class="col-md-6">
				<p>Total no. of canidates with blood group AB- are <?php
					$query = "SElECT * FROM registration_data WHERE blood_group = 'ABn'";
					$res = mysqli_query($con,$query);
					$no = mysqli_num_rows($res);
					echo $no;
					?>
		...
		<div class="row">
			<div class="col-md-6">
				<p>Total no. of canidates with blood group O+ are <?php 
					$query = "SElECT * FROM registration_data WHERE blood_group = 'Op'";
					$res = mysqli_query($con,$query);
					$no = mysqli_num_rows($res);
					echo $no;
					?>
		...
		<div class="row">
			<div class="col-md-6">
				<p>Total no. of canidates with blood group O- are <?php 
					$query = "SElECT * FROM registration_data WHERE blood_group = 'On'";
					$res = mysqli_query($con,$query);
					$no = mysqli_num_rows($res);
					echo $no;
					?>
		...
		<div class="row">
			<div class="col-md-6">
				<p>Total no. of canidates with blood group not available are <?php 
					$query = "SElECT * FROM registration_data WHERE blood_group = 'NA'";
					$res = mysqli_query($con,$query);
					$no = mysqli_num_rows($res);
					echo $no;
					?>
		...
		<div class="row">
			<div class="col-md-6">
				<form action="http://localhost/BDC/admin/delete.php" method="POST">
...
//include('../includes/dbconnect.php');
		...
		if(mysqli_num_rows($res))
		{
			...
			echo '<table id="myTable" class="table table-striped" style="display: block;width: 150%;overflow-x: scroll;">
			<tr>
				<th>Student No</th>
				<th>Name</th>
				<th>Gender</th>
